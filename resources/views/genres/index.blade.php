...
<head>
    ...
    <title>Index Genre - Khairi Store</title>
...
<body style="background: lightgrey">
    <header>
        ...
        <li><a href="https://www.github.com/abdurrahmankhairii/"><img src="img/github.png" style="width:50px" alt="GitHub"></a></li>
        </ul>
    </header>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('genres.create') }}" class="btn btn-md btn-success mb-3">ADD GENRE MUSIC</a>
                            ...
                            <tbody>
                                @forelse ($genres as $genre)
                                    <tr>
                                        <td class="text-center">
                                            <img src="{{ asset('/storage/genres/'.$genre->image) }}" class="rounded" style="width: 150px">
                                        </td>
                                        <td>{{ $genre->genre_music }}</td>
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Are You Sure ?');" action="{{ route('genres.destroy', $genre->id) }}" method="POST">
                                                <a href="{{ route('genres.show', $genre->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                ...
                                @empty
                                    <div class="alert alert-danger">
                                        Data Genre Music Not Yet Ready.
                                    </div>
                                @endforelse
                            </tbody>
                        </table>
